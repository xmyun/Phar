...
DATASET_PATH = r'/mnt/home/xuemeng/ttaIMU/IMU_Hete/Datasets/Hhar/Raw'
...
# acc + gyro
path_save = r'/mnt/home/xuemeng/ttaIMU/cotta_imu/Datasets/Hhar/Read2Py'
window_time=20
version = str(window_time) + '_120'
data, label = preprocess_hhar(DATASET_PATH, path_save, version, window_time=window_time, seq_len=120)
