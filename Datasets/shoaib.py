...
DATASET_PATH = r'/mnt/home/xuemeng/ttaIMU/IMU_Hete/Datasets/Shoaib/Raw'
...
path_save = r'/mnt/home/xuemeng/ttaIMU/IMU_Hete/Datasets/Shoaib/Read2Py'
window_time=20
version = str(window_time) + '_120'
data, label = preprocess(DATASET_PATH, path_save, version, target_window=window_time, seq_len=120)
