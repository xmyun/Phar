...
DATASET_PATH = r'/mnt/home/xuemeng/ttaIMU/IMU_Hete/Datasets/Uci/Raw'
...
# activity, user
path_save = r'/mnt/home/xuemeng/ttaIMU/IMU_Hete/Datasets/Uci/Read2Py'
window_time=20
version = str(window_time) + '_120'
data, label = preprocess(DATASET_PATH, path_save, version, target_sr=window_time, seq_len=120)
