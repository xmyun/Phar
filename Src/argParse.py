...
def set_arg(): 
    ...
    parser.add_argument('--e', '--encoder_file', type=str, default=None, help='Pretrain encoder and decoder file.')
    
    args = parser.parse_args()
    args = load_model_config(args, args.model)
    
    #/mnt/home/xuemeng/ttaIMU/IMU_Hete/config/dataset.json
    json_data_path = '../../phar_1101/config_rawVersion/dataset.json'
    json_model_path = '../../phar_1101/config_rawVersion/model.json'
    json_train_path = '../../phar_1101/config_rawVersion/train.json'
    json_mask_path = '../../phar_1101/config_rawVersion/mask.json'
...
def load_model_config(args, model, path_bert='../../phar_0815/config_rawVersion/encoder.json', path_classifier='../../phar_0815/config_rawVersion/model.json'):
    model_cfg = None
