...
AdaptLogFileName="saved/log/Adapt_IOS_"$SrouceDomain$TargetDomain"_"$timestamp".log" 
...
nohup python -u iosmodel_eh.py --dataset new_20_120 --model $modelP --g $GPUNum --cd $CroTyp --SDom $SrouceDomain --TDom $TargetDomain > $AdaptLogFileName &
